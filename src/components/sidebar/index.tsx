    ...
    <div>
      ...
      <div className="pr-[5px]">
        <div className="flex items-center border border-cs-light-orange px-2 py-1 mt-6">
          ...
          <input
            type="text"
            className="outline-none w-[100px] bg-transparent flex-grow"
          />
        </div>
      </div>
      <div className="flex mt-4 text-[12px]">
        <p
          ...
          style={{ background: selectedOption === "all" ? "#5C5656" : "" }}
        ...
        <p
          ...
          style={{ background: selectedOption === "new" ? "#5C5656" : "" }}
        ...
        <p
          className="px-1 cursor-pointer"
          style={{ background: selectedOption === "mentions" ? "#5C5656" : "" }}
          onClick={() => setSelectedOption("mentions")}
        >
          MENTIONS
        </p>
      </div>
